# Differential Abundance Code (Genus)

# Runs differential abundance analysis using ANCOM-BC2 at the genus level for 16S/shotgun phyloseq objects
...
outdir <- "16S/differential_abundance/stool_active/Genus"
...
# ── 5)  Remove zero-variance Genera ────────────────────────────
#Note some Genera will have zero variance and will need to be removed before ANCOM c("Genus","Genus")
bad_asvs <- c("")
...
##  ── 18) Add mean relative-abundance columns (overall & by Celiac status) ─────────────────────
